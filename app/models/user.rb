class User < ApplicationRecord
    ...
    def most_songs_artists
        self.all_artists.max_by{|artist| artist.projects}
    end
    def least_songs_artists
        self.all_artists.min_by{|artist| artist.projects}
    end
    ...
    def average_song_views_of_artist
        average_views= self.projects.map{|avg| avg.views}
        average_views.sum.to_f/average_views.count
    end
    def average_song_plays_of_artist
        average_plays = self.projects.map{|avg| avg.plays}
        average_plays.sum.to_f/average_plays.count
    end
